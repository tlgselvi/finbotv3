 ...
 */
export function generateEnhancedPDF(template, style = getDefaultStyle()) {
 ...
 */
function generateSummarySection(summary, currency) {
 ...
 */
function generateDataSection(data, reportType) {
 ...
 */
function generateCashFlowBridgeTable(data) {
    return `
    <table class="table">
      <thead>
        <tr>
 ...
 */
function generateAgingTable(data) {
    return `
    <table class="table">
      <thead>
        <tr>
 ...
 */
function generateRunwayTable(data) {
    return `
    <table class="table">
      <thead>
        <tr>
 ...
 */
function generateAssumptionsSection() {
    return `
 ...
 */
function generateMethodologySection(reportType) {
    let methodology = '';
    switch (reportType.toLowerCase()) {
        case 'cash flow bridge report':
            methodology =
...
function getSummaryClassName(key, value) {
    if (typeof value === 'number') {
...
function getAgingStatusClass(bucket) {
    switch (bucket) {
        case '0-30':
            return 'status-good';
        case '30-60':
...
function getRunwayStatusClass(months) {
    if (months > 12)
        return 'status-good';
    if (months > 6)
        return 'status-warning';
