 ...
 */
export function generateCashBridgeReport(accounts, transactions, startDate, endDate) {
 ...
 */
export function exportCashBridgeToCSV(report, locale = 'tr-TR') {
 ...
 */
export function getCashBridgePeriods() {
    const now = new Date();
    const periods = [];
    // Current month
