...
export class CSVExporter {
     ...
     */
    static exportTransactions(transactions, locale = 'tr-TR') {
     ...
     */
    static exportAccounts(accounts, locale = 'tr-TR') {
        const settings = localeSettings[locale];
        const headers = [
            settings.headers.id,
     ...
     */
    static exportFinancialSummary(data, locale = 'tr-TR') {
        const settings = localeSettings[locale];
    ...
    static validateLocale(locale) {
        const supportedLocales = ['tr-TR', 'en-US', 'de-DE'];
