...
export class PDFExporter {
     ...
     */
    static generateAdvancedFinancialReport(transactions, accounts, summary, riskAnalysis, consolidationBreakdown) {
    ...
    static generateTransactionReport(transactions, accounts, summary) {
    ...
    static generateAccountStatement(account, transactions, period) {
        let html = `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    static generateFinancialDashboard(accounts, summary, recentTransactions) {
        let html = `
      <!DOCTYPE html>
      <html>
      <head>
