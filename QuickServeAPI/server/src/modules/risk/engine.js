 ...
 */
function calculateRiskImpacts(parameters) {
 ...
 */
function calculateRiskScore(parameters) {
    const impacts = calculateRiskImpacts(parameters);
    const totalImpact = impacts.fxImpact +
        impacts.rateImpact +
 ...
 */
function calculateCashFlow(baseCash, parameters) {
 ...
 */
export function analyzeRiskScenarios(baseCash, parameters) {
 ...
 */
export function generateRiskRecommendations(result) {
