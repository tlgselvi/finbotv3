...
import { runScenarioAnalysis, compareScenarios, getScenarioRecommendations, SCENARIO_HORIZONS, } from '../modules/scenario/engine';
import { logger } from '../utils/logger';
const router = Router();
// GET /api/scenario/horizons - Get available scenario horizons
router.get('/horizons', requireAuth, async (req, res) => {
    try {
        res.json({
            success: true,
