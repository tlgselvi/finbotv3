 ...
 */
router.get('/runway/:userId', asyncHandler(async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/cash-gap/:userId', asyncHandler(async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
 ...
 */
router.get('/forecast/:userId', asyncHandler(async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
    const months = parseInt(req.query.months as string) || 12;
