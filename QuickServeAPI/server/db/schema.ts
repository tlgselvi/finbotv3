...
export type InsertAgingReport = typeof agingReports.$inferInsert;

export type BankIntegration = typeof bankIntegrations.$inferSelect;
export type InsertBankIntegration = typeof bankIntegrations.$inferInsert;

export type Cashbox = typeof cashboxes.$inferSelect;
export type InsertCashbox = typeof cashboxes.$inferInsert;
export type UpdateCashbox = InsertCashbox;

export type CashboxTransaction = typeof cashboxTransactions.$inferSelect;
export type InsertCashboxTransaction = typeof cashboxTransactions.$inferInsert;
export type TransferCashbox = InsertCashboxTransaction;

export type CashboxAuditLog = typeof cashboxAuditLogs.$inferSelect;
export type InsertCashboxAuditLog = typeof cashboxAuditLogs.$inferInsert;
