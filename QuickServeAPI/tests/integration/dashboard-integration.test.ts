...
test.describe('Dashboard Integration Tests', () => {
  ...
  test('Dashboard Widget Integration', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="widget-financial-health"]')
    ).toBeVisible();
    ...
    await expect(
      page.locator('[data-testid="widget-aging-summary-ar"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="widget-aging-summary-ap"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="widget-aging-table-ar"]')
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="widget-aging-table-ap"]')
    ).toBeVisible();
  });
  ...
  test('Widget Toggle Functionality', async ({ page }) => {
    ...
    // Toggle a widget off
    await page.click(
      '[data-testid="widget-financial-health"] button[data-testid="toggle-widget"]'
    );
  ...
  test('Tab Navigation', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="tab-aging"]')).toHaveAttribute(
      'data-state',
      'active'
    );

    await page.click('[data-testid="tab-analytics"]');
    await expect(page.locator('[data-testid="tab-analytics"]')).toHaveAttribute(
      'data-state',
      'active'
    );

    await page.click('[data-testid="tab-reports"]');
    await expect(page.locator('[data-testid="tab-reports"]')).toHaveAttribute(
      'data-state',
      'active'
    );

    await page.click('[data-testid="tab-overview"]');
    await expect(page.locator('[data-testid="tab-overview"]')).toHaveAttribute(
      'data-state',
      'active'
    );
  });
  ...
  test('Dashboard Layout Persistence', async ({ page }) => {
    ...
    // Toggle a widget
    await page.click(
      '[data-testid="widget-runway"] button[data-testid="toggle-widget"]'
    );
    ...
    await expect(
      page.locator('[data-testid="widget-runway"]')
    ).not.toBeVisible();
  });
  ...
  test('Data Consistency', async ({ page, request }) => {
    ...
    const uiData = await page.evaluate(() => {
      const financialHealthWidget = document.querySelector(
        '[data-testid="widget-financial-health"]'
      );
      return {
  ...
  test('Analytics Integration', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="analytics-placeholder"]')
    ).toBeVisible();
  });
