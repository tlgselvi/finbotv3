...
export const createHealthyScenario = async (
  db: any,
  userId: string,
  accountId: string
) => {
...
export const createWarningScenario = async (
  db: any,
  userId: string,
  accountId: string
) => {
...
export const createCriticalScenario = async (
  db: any,
  userId: string,
  accountId: string
) => {
...
export const createPositiveCashGapScenario = async (
  db: any,
  userId: string,
  accountId: string
) => {
...
export const createNegativeCashGapScenario = async (
  db: any,
  userId: string,
  accountId: string
) => {
...
export const cleanupTestData = async (db: any, userId: string) => {
  await db
    .delete(db.schema.transactions)
    .where(db.eq(db.schema.transactions.user_id, userId));
  await db
    .delete(db.schema.accounts)
    .where(db.eq(db.schema.accounts.user_id, userId));
  await db
    .delete(db.schema.arApItems)
    .where(db.eq(db.schema.arApItems.user_id, userId));
};
